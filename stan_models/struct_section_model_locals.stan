// Fit-105 model-local equivalent of
// struct_section_transformed_parameters.stan (revision c885f83). Bounds are
// omitted because Stan does not permit constrained local variables.
#include dist_transformed_parameters_local.stan
...
#include beliefs_transformed_parameters.stan
  ...
  row_vector[fit_model_to_data ? num_clusters : 0] structural_cluster_takeup_prob;
  ...
  vector[use_cluster_effects ?  num_clusters : num_treatments] u_sd;
  vector[use_cluster_effects ? num_clusters : num_treatments] total_error_sd;
  vector[use_cluster_effects ? num_clusters : 0] raw_cluster_sd;
