// Fit-105 model-local equivalent of dist_transformed_parameters.stan.
// Local variables cannot use `ordered`; ordering is already enforced on the
// sampled group_dist_mean_raw parameter.
