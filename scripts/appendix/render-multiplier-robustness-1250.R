...
specification_catalog <- tibble::tribble(
  ...
  "main", "Social-image valuation ($\\\\lambda$)", "grouped-lambda",
    "By public-signal status",
  "main", "Social-image valuation ($\\\\lambda$)", "arm-specific-lambda",
    "By treatment arm",
  "main", "Distribution of intrinsic motivation ($v$)", "student-t5",
    "Heavy-tailed $v$ distribution",
  "main", "Distribution of intrinsic motivation ($v$)", "finite-mixture",
    "Mixture $v$ distribution",
  "prior", "Benchmark specification", "baseline", "Benchmark",
  "prior", "Social-image valuation ($\\\\lambda$)", "image-tight",
    "Tighter prior",
  "prior", "Social-image valuation ($\\\\lambda$)", "image-diffuse",
    "More diffuse prior",
  "prior", "Distance cost ($\\\\delta$)", "distance-tight",
    "Tighter prior",
  "prior", "Distance cost ($\\\\delta$)", "distance-diffuse",
    "More diffuse prior",
  "prior", "Idiosyncratic decision noise ($\\\\sigma_u$)",
    "heterogeneity-tight", "Tighter prior",
  "prior", "Idiosyncratic decision noise ($\\\\sigma_u$)",
    "heterogeneity-diffuse", "More diffuse prior",
  "prior", "Observability parameters", "visibility-tight", "Tighter prior",
  "prior", "Observability parameters", "visibility-diffuse",
    "More diffuse prior",
  "prior", "Private payoffs and item values", "private-tight",
    "Tighter priors",
  "prior", "Private payoffs and item values", "private-diffuse",
    "More diffuse priors",
  "prior", "All priors varied together", "joint-tight", "Tighter priors",
  "prior", "All priors varied together", "joint-diffuse",
    "More diffuse priors"
) |>
