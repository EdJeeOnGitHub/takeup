...
specification_catalog <- tibble::tribble(
  ...
  "main", "Baseline", "baseline", "Baseline",
  "main", "Distance, information, and sample", "private-distance-community-image",
    "Household private distance; community social image",
  "main", "Distance, information, and sample", "full-information",
    "Full information",
  ...
  "main", "Social-image weight", "arm-specific-lambda",
    "Arm-specific $\\lambda$",
  "main", "Type distribution", "student-t5", "Student-$t(5)$ types",
  "main", "Type distribution", "finite-mixture",
    "Two-component Gaussian-mixture types",
