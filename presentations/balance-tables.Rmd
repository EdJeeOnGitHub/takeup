...
```{r, results="asis"}
#| comp-balance-table,
#| dependson=c("balance-setup", "balance-creation"), eval=FALSE
...
panel_names = c(
      ...
      str_glue("Panel B: Baseline demographics, $N={format(N_pretreat, big.mark = ',')}$"),
      str_glue("Panel C: Baseline knowledge, $N={format(N_baseline_worm, big.mark = ',')}$"),
      str_glue("Panel D: Social image concerns, $N={format(N_baseline_worm, big.mark = ',')}$"),
      str_glue("Panel E: Implementation, $N={format(N_endline, big.mark = ',')}$")
)
