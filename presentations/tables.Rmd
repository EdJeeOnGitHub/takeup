...
optim_post_name = "posterior-optimal-distance-lambda_0-externality_0-model_STRUCTURAL_LINEAR_U_SHOCKS_PHAT_MU_REP-fit-version_86.csv"

optim_post_df = read_csv(
  file.path(
    "temp-data",
    optim_post_name
  )
...
optim_post_df %>%
  mutate(
    minus_control = optimal_distance
  )
