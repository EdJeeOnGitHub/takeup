...
lhs_translation_df = tribble(
  ...
  "lhs: cluster.dist.to.pot", "Distance to PoT",
  "lhs: n_per_cluster", "Census count per cluster"
) %>%
  mutate(
...
# attr(comp_bal_table, "kable_meta")$contents = str_replace_all(attr(comp_bal_table, "kable_meta")$contents, "removeme12345", " ")
# comp_bal_table[1] = str_replace_all(comp_bal_table[1], "removeme12345", " ")
