...
\node[draw, rounded corners=2pt, align=center,
  ...
  (census)
  {\textbf{Census frame:} 144 clusters,\ 39{,}301 adults (18+)};
...
\node[analysis, below=of bl-reach] (bl-comp)
  {Completed baseline: 1{,}995\\(\emph{Main analysis sample})};
...
\node[colgroup,
      ...
      label={[font=\small\bfseries]above:Baseline}] {};
...
\node[analysis, dashed, below=of mon-uniq] (mon-ana)
  {Excl. SMS treatment: 9{,}805\\(\emph{Main analysis sample})};
...
\node[colgroup,
      ...
      label={[font=\small\bfseries, yshift=8mm]above:Monitored takeup sample}] {};
...
\node[analysis, below=of el-comp] (el-comp-nosms)
  {Excl.\ SMS treatment: 2{,}659\\(\emph{Main analysis sample})};
...
%% ── Column C group box ───────────────────────────────────────────
\node[colgroup,
      fit=(el-frame)(el-sel)(el-reach)(el-comp)(el-comp-nosms)(el-miss)(el-nc),
      label={[font=\small\bfseries]above:Endline}] {};
