...
- **ToDo 6, \(\sigma_u\) identification**: Analysis `fe9c8d8` adds the prior/posterior plotting script and summary output. Overleaf `10cfa9c` adds the identification text and Appendix Figure `fig:sigma-u-prior-posterior`.
