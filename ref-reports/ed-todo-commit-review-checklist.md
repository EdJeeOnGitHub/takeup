...
| 17 Figure M1 parameters | Paper | `7df4781` | Accept | Applied to Overleaf `main` as `b05d100` and pushed to `overleaf/master`; parameters verified in `archive/code/scratch/quick-vstar.jl`, with “type index” wording used without the hyphen. |
