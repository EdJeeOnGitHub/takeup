...
Usage:
  generate_bayesian_sensitivity_quantities.R <fit-version> --model=<model> [options]

Options:
  --analysis-file=<path>  Saved run_takeup.R workspace [default: data/stan_analysis_data/dist_fit{fit-version}.RData]
