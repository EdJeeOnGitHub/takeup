...
rather than location. We also report two specifications that move all five
modules together, once tightening them and once making them more diffuse.
...
\begin{table}[htbp]
  ...
  \begin{threeparttable}
    ...
    \begin{tablenotes}[flushleft]\footnotesize
      ...
      only the named prior module; the final two rows change all modules together.
    \end{tablenotes}
  \end{threeparttable}
\end{table}
}{}
