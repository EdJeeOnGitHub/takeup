...
ed_edits_base.prepare.baseline.endline.data <- function(.data, .cluster.strat.data) { #, .census.data) {
  .data %>% 
    ...
    # these columns don't seem to exist
...
ed_edits_prepare.endline.data <- function(.data, .census.data, .cluster.strat.data) {
  .data %>% 
    ...
    ungroup() %>% 
    ed_edits_base.prepare.baseline.endline.data(.cluster.strat.data) %>% 
...
ed_edits_prepare.baseline.data <- function(.data, .cluster.strat.data) {
  .data %>% 
    ed_edits_base.prepare.baseline.endline.data(.cluster.strat.data) %>% 
